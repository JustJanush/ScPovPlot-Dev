...
// == scalar potential ======
#declare _IsoPot        =  2;  //Isosurface of constant potential textured by potential gradient,
#declare _InterPot      =  1;
...
#local gMin  = 0;//-3.5;
#local gMin2 = 0;
#local gMax  = 35E6; // [mV/A] gradient range, tuned to THIS example; (1-clock)*5E3+clock*5E4; // 5E7;
