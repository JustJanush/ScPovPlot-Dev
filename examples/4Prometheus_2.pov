...
#version 3.7;
#local _FileName   = "4Prometheus.pov";
#local _FileVerMaj = "4.0.0";
#local _FileVerMin = "2018-09-22";
...
#ifdef(bgr)
  background {rgbt bgr*<1,1,1,0>+<0,0,0,0>} // bgr - shade of gray
#else
...
#declare rr  = .2*dd;
#declare rc  =  rr/3;
#local alf_  =    25 + (190/100*49) + 3.8*clock;
#local the_  =    41; // +20*clock;
#local dst_  =    40; // default camera distance 
//#local _T    =   -5000+(frame_number-1)*100; // 165; // [mV] 23094.0*sin(pi*pow((2*clock-1),5)/3); //+20000*pow(clock,3);
#local _T    =   100*pow((frame_number-51),3)/pow(50,3); // 165; // [mV] 23094.0*sin(pi*pow((2*clock-1),5)/3); //+20000*pow(clock,3);
//============================
...
#end
        DrawInterpolGrdSrf2( _T, dd)

//        DrawInterpolGrdSrf2( -_T*50, dd)
//        DrawInterpolGrdSrf2( -_T/1 , dd)
//        DrawInterpolGrdSrf2(   0   , dd)
//        DrawInterpolGrdSrf2(  _T/1 , dd)
//        DrawInterpolGrdSrf2(  _T*50, dd)
